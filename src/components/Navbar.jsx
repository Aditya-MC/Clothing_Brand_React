...
export default function Navbar(){
    return(
        <nav className="bg-yellow-950 top-0 left-0 right-0 z-50 backdrop-blur bg-white/30">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
                <div className="flex items-center gap-4">
                    <div className="text-2xl font-bold text-white">STREET LACE</div>
                </div>

                <div className="hidden md:flex items-center gap-8 text-sm text-white cursor:pointer">
                ...
                <div className="flex tems-center gap-4">
                    <button className="btn bg-black text-white hover:scale-105 transform transition cursor-pointer">Shop now</button>
